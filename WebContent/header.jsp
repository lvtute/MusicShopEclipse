					...
					<div class="header-right1 ">
						<ul>
							...
							<li><i class="glyphicon glyphicon-user"></i><a
								href="navigate.jsp">Chào <%=user.getUserName()%></a></li>
							<%
								}
							%>
							<%
							...
							<li><i class="glyphicon glyphicon-log-in"></i><a
								href="navigate.jsp">My Account</a></li>
							<%
								}
							%>
							...
							<a href="checkout.jsp">
								<h3>
									<div class="total">
										...
										<span class="last_price"><%=formatter.format(cart.totalCart())%></span>
										VNĐ <span> (Xem giỏ hàng)</span>
									</div>
									<img src="images/cart.png" alt="" />
								</h3>
							</a> <a href="javascript:;" class="simpleCart_empty">Làm trống
								giỏ</a>
					...
					<div class="navbar-header nav_2">
						...
						<div class="navbar-brand logo-nav-left ">
							<h1 class="animated wow pulse" data-wow-delay=".5s">
								<a href="index.jsp">demo<span> ACOUSTIC SHOP</span></a>
							</h1>
						</div>
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav">
							...
							<li class="dropdown"><a href="#" class="dropdown-toggle"
								data-toggle="dropdown">Nhạc Cụ <b class="caret"></b></a>
								<ul class="dropdown-menu multi">
									...
									<div class="row-top">
										<div class="col-sm-6 row1">
											<a href="guitar.jsp"><img src="images/me.jpg" alt=""
												class="img-responsive"></a>
										</div>
										<div class=" col-sm-6 row2">
											<a href="piano.jsp"><img src="images/me1.jpg" alt=""
												class="img-responsive"></a>
										</div>
										<div class="clearfix"></div>
									</div>
									...
									<div class="row-top">
										<div class="col-sm-6 row1">
											<a href="productbrand.jsp?brand=1"><img
												src="images/taylor.jpg" alt="" class="img-responsive"></a>
										</div>
										<div class=" col-sm-6 row2">
											<a href="productbrand.jsp?brand=8"><img
												src="images/kawai.jpg" alt="" class="img-responsive"></a>
										</div>
										<div class="clearfix"></div>
									</div>
								</ul></li>
