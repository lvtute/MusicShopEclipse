	...
	<div class="banner-top">
		<div class="container">
			...
			<h3 class="animated wow fadeInRight" data-wow-delay=".5s">
				<a href="index.html">Trang Chủ</a><label>/</label>Đăng Ký
			</h3>
			...
			<form action="UserServlet" method="POST">
				<div class="col-md-6 login-do1 animated wow fadeInLeft"
					...
					<div class="login-mail">
						<input type="text" placeholder="Tên đăng nhập" name="name"
							id="name" required> <i class="glyphicon glyphicon-user"></i>
						<span id="user-result"></span>
					</div>
					<div class="login-mail">
						<input type="text" placeholder="Email" name="email" id="email"
							required> <i class="glyphicon glyphicon-envelope"></i> <span
							id="user-result"></span>
					</div>
					<div class="login-mail">
						<input type="text" placeholder="Điện thoại" name="phone"
							id="phone" required> <i class="glyphicon glyphicon-phone"></i>
						<span id="user-result"></span>
					</div>

					<div class="login-mail">
						<input type="password" placeholder="Mật khẩu" name="pass"
							id="pass" required> <i class="glyphicon glyphicon-lock"></i>
						<span></span>
					</div>

					<div class="login-mail">
						<input type="password" placeholder="Xác Nhận Mật khẩu"
							name="confirm_pass" id="confirm_pass" required>
						
						<script>
							$('#pass, #confirm_pass').on(
									'keyup',
									function() {
										if ($('#pass').val() == $(
												'#confirm_pass').val()) {
											$('#message').html('Trùng khớp')
													.css('color', 'green');
										} else
											$('#message').html(
													'Không trùng khớp').css(
													'color', 'red');
									});
						</script>
						

						<i class="glyphicon glyphicon-lock"></i> <span></span><span
							id='message'></span>
					</div>
					<!-- <div class="login-mail">
						<script type="text/javascript">
							document.write("Kết quả của " + a + " + " + b
									+ " là ? ");
						</script>
						<input type="input" name="input" value="" /> <i
					...
					<div class="login-mail" href="#">
						<label class="checkbox1"><input type="checkbox"
							name="checkbox"><i> </i>Tôi đồng ý với các điều khoản.</label>
						<!-- <fieldset disabled>
							<div class="form-group">
								<label for="disabledTextInput">Điều khoản tại website
									demo ACOUSTIC SHOP</label>
								<textarea type="text" id="disabledTextInput"
									class="form-control" placeholder="">* Bạn hãy chắc địa chỉ bạn gửi là đúng. &#10;* Sau 3 ngày không chuyển khoản, đơn hàng sẽ xóa.&#10;</textarea>
						</fieldset> -->
				...
				<div class="col-md-6 login-do animated wow fadeInRight"
					...
					<label class="hvr-sweep-to-top login-sub"> <input
						type="hidden" value="insert" name="command"> <input
