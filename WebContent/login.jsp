...
<body>
	...
	<div class="banner-top">
		<div class="container">
			<h2 class="animated wow fadeInLeft" data-wow-delay=".5s">ĐĂNG
				NHẬP</h2>
			<h3 class="animated wow fadeInRight" data-wow-delay=".5s">
				<a href="index.html">Trang Chủ</a><label>/</label>Đăng Nhập
			</h3>
				...
				<div class="col-md-6 login-do1 animated wow fadeInLeft"
					...
					<div class="login-mail">
						<input type="text" placeholder="Tên tài khoản" name="name"
							required> <i class="glyphicon glyphicon-envelope"></i>
					</div>
					<div class="login-mail">
