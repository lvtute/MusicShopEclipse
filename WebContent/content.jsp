...
<body>
	...
	<div class="content">
		<div class="content-head">
			...
			<div class="col-md-6 col-m1 animated wow fadeInLeft"
				data-wow-delay=".1s">
				<div class="col-1">
					<div class="col-md-6 col-2">
						<a href="guitar.jsp"><img src="images/pi3.jpg"
							class="img-responsive" alt=""> </a>
					</div>
					<div class="col-md-6 col-p">
						<h5>GUITAR SHOP</h5>
						<p>Chúng tôi có rất nhiều những sản phẩm nổi tiếng từ các hãng
							lớn như Taylor, Fender, Yamaha, Gibson...</p>
						<a href="guitar.jsp" class="shop" data-hover="Xem Ngay">Xem
							Ngay</a>
					</div>
				...
				<div class="col-1">
					<div class="col-md-6 col-p">
						<h5>PIANO SHOP</h5>
						<p>Chúng tôi có rất nhiều những sản phẩm nổi tiếng từ các hãng
							lớn như Roland, Casio, Yamaha, Samick...</p>
						<a href="piano.jsp" class="shop" data-hover="Xem Ngay">Xem
							Ngay</a>
					</div>
					<div class="col-md-6 col-2">
						<a href="piano.jsp"><img src="images/pi.jpg"
							class="img-responsive" alt=""> </a>
					</div>
					<div class="clearfix"></div>
				</div>
				...
				<div id="owl-demo" class="owl-carousel">
					...
					<div class="item">
						...
						<a href="single.jsp?productID=<%=p.getProductID()%>"><img
							...
							alt="" /></a> <a href="single.jsp?productID=<%=p.getProductID()%>"
							class="shop-2">Xem Ngay</a>
	...
	<div class="content-top">
		<div class="col-md-5 col-md1 animated wow fadeInLeft"
			data-wow-delay=".1s">
			<div class="col-3">
				<a href="guitar.jsp"><img src="images/pi1.jpg"
				...
				<div class="grid-pro">
					<div class=" grid-product ">
						<figure>
							<a href="single.jsp?productID=<%=p.getProductID()%>">
								<div class="grid-img">
									<img src="<%=p.getProductImageBack()%>" class="img-responsive"
										alt="">
								</div>
								<div class="grid-img">
									<img src="<%=p.getProductImageForward()%>" alt="" width="132%"
										height="180" class="img-responsive">
								</div>
							</a>
						</figure>
					</div>
					<div class="women">
						...
						<a href="CartServlet?command=plus&productID=<%=p.getProductID()%>"
							data-text="Thêm vào giỏ" class="but-hover1 item_add">Thêm vào
							giỏ</a>
					</div>
				</div>
			</div>
		...
		<div class="content-top">
			...
			<div class="col-md-5 col-md1 animated wow fadeInRight"
				data-wow-delay=".1s">
				<div class="col-3">
					<a href="piano.jsp"><img src="images/pi2.jpg"
						class="img-responsive " alt="">
						<div class="col-pic">
							<h5>Piano - Organ</h5>
