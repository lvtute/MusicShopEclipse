...
<body>
	...
	<div class="banner-top">
		<div class="container">
			<h2 class="animated wow fadeInLeft" data-wow-delay=".5s">Đơn
				Phẩm</h2>
			<h3 class="animated wow fadeInRight" data-wow-delay=".5s">
				<a href="index.html">Trang Chủ</a><label>/</label>Đơn Phẩm
			</h3>
	...
	<div class="product">
		<div class="container">
					...
					<div class="price-head">
						<div class="col-md-6 price-head1">
							<div class="price-top1">
								<span class="price-top">$</span> <input type="text" value="0">
							</div>
						</div>
						<div class="col-md-6 price-head2">
							<div class="price-top1">
								<span class="price-top">$</span> <input type="text" value="500">
							</div>
						</div>
						<div class="clearfix"></div>
					</div>
						...
						<div class="product-go">
							<div class=" fashion-grid">
								<a href="single.jsp?productID=<%=p.getProductID()%>"><img
									class="img-responsive " src="<%=p.getProductImageForward()%>"
									alt=""></a>
							...
							<div class=" fashion-grid1">
								...
								<span class=" price-in1"><%=formatter.format(p.getProductPrice())%>
									VNĐ</span>
								<p>
									<a
										href="CartServlet?command=plus&productID=<%=p.getProductID()%>"
										data-text="Thêm vào giỏ" class="but-hover1 item_add">Thêm
										vào giỏ</a>
								</p>
							</div>
			...
			<div class="col-md-9 animated wow fadeInRight" data-wow-delay=".5s">
					...
					<div class="flexslider">
						<ul class="slides">
							...
							<li data-thumb="<%=product.getProductImageForward()%>">
								<div class="thumb-image">
									<img src="<%=product.getProductImageForward()%>"
										data-imagezoom="true" class="img-responsive">
								</div>
							</li>
							<li data-thumb="<%=product.getProductImageBack()%>">
								<div class="thumb-image">
									<img src="<%=product.getProductImageBack()%>"
										data-imagezoom="true" class="img-responsive">
								</div>
							</li>
						</ul>
				...
				<div class="col-md-7 single-top-in">
					<div class="span_2_of_a1 simpleCart_shelfItem">
						...
						<div class="price_single">
							...
							<br> <span class="reducedfrom item_price"><%=formatter.format(product.getProductPrice())%>
								VNĐ</span> <a
					...
					<div class="sap_tabs">
						<div id="horizontalTab"
							...
							<ul class="resp-tabs-list">
								<li class="resp-tab-item " aria-controls="tab_item-0" role="tab"><span>Mô
										Tả Sản Phẩm</span></li>
								<li class="resp-tab-item" aria-controls="tab_item-1" role="tab"><span><i
										class="glyphicon glyphicon-info-sign"></i> Thông Tin Chi Tiết</span></li>
								<li class="resp-tab-item" aria-controls="tab_item-2" role="tab"><span><i
										class="glyphicon glyphicon-edit"></i> Đánh Giá</span></li>
								<div class="clearfix"></div>
							</ul>
							<div class="resp-tabs-container">
								<h2 class="resp-accordion resp-tab-active" role="tab"
									aria-controls="tab_item-0">
									<span class="resp-arrow"></span>Mô Tả Sản Phẩm
								</h2>
								...
								<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-2">
									<div class="comments-top-top">
										...
										<div class="top-comment-right">
											<h6>
												<a href="#"><%=r.getReviewName()%></a> - Đánh giá sản phẩm :
												<%=r.getReviewStar()%>/5
											</h6>
										...
										<a class="add-re"
											href="review.jsp?command=insert&product_id=<%=product.getProductID()%>"><i
											class="glyphicon glyphicon-comment"></i> Viết Đánh Giá</a>
									</div>
				...
				<div class='fb-comments' data-num-posts='5' data-width='100%'
					...
					<div class="col-sm-5 item-grid simpleCart_shelfItem">
						...
						<div class="grid-pro">
							...
							<div class="women">
								...
								<p>
									<em class="item_price"><%=formatter.format(p.getProductPrice())%>
										VNĐ</em>
								</p>
								<a
									href="CartServlet?command=plus&productID=<%=p.getProductID()%>"
